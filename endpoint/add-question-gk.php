...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['quiz_question'], $_POST['option_a'], $_POST['option_b'], $_POST['option_c'], $_POST['option_d'], $_POST['correct_answer'])) {
        ...
        try {
            $stmt = $conn->prepare("INSERT INTO gk (quiz_question, option_a, option_b, option_c, option_d, correct_answer) VALUES (:quiz_question,:option_a, :option_b, :option_c, :option_d, :correct_answer)");
            ...
            <script>
                ...
                window.location.href = 'http://localhost/online-quiz-system/teacherGK.php';
            </script>
            ";
            exit();
