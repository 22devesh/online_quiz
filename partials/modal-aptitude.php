<!-- Add Quiz Modal -->
<div class="modal fade mt-5" id="addQuestionModal-aptitude" tabindex="-1" aria-labelledby="addQuiz" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="./endpoint/add-question-aptitude.php" method="POST">
...
<!-- Update Quiz Modal -->
<div class="modal fade mt-5" id="updateQuestionModal-aptitude" tabindex="-1" aria-labelledby="addQuiz" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="./endpoint/update-question-aptitude.php" method="POST">
