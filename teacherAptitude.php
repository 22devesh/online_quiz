...
include('./partials/modal-aptitude.php');
?>
            ...
            <div class="quiz">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <button type="button" class="btn btn-dark m-2 float-left" id="add-quiz-button" data-toggle="modal" data-target="#addQuestionModal-aptitude">
                            Add Question
                        </button>
                        ...
                        <div class="table-area">
                            <table class="table" style="color: white;">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $stmt = $conn->prepare('SELECT * FROM `aptitude`');
                                    $stmt->execute();
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-secondary" onclick="updateQuestionAptitude(<?= $quizID ?>)"><i class="fa-solid fa-pencil"></i></button>
                                                <button type="button" class="btn btn-danger" onclick="deleteQuestionAptitude(<?= $quizID ?>)"><i class="fa-solid fa-trash"></i></button>
                                            </td>
                                        </tr>
