...
include('./partials/modal-english.php');
?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-secondary" onclick="updateQuestionEnglish(<?= $quizID ?>)"><i class="fa-solid fa-pencil"></i></button>
                                                <button type="button" class="btn btn-danger" onclick="deleteQuestionEnglish(<?= $quizID ?>)"><i class="fa-solid fa-trash"></i></button>
                                            </td>
                                        </tr>
