                        ...
                        <div class="table-area">
                            <table class="table" style="color: white;">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $stmt = $conn->prepare('SELECT * FROM `gk`');
                                    $stmt->execute();
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-secondary" onclick="updateQuestionGK(<?= $quizID ?>)"><i class="fa-solid fa-pencil"></i></button>
                                                <button type="button" class="btn btn-danger" onclick="deleteQuestionGK(<?= $quizID ?>)"><i class="fa-solid fa-trash"></i></button>
                                            </td>
                                        </tr>
