<!-- Add Quiz Modal -->
<div class="modal fade mt-5" id="addQuestionModal-english" tabindex="-1" aria-labelledby="addQuiz" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="./endpoint/add-question-english.php" method="POST">
...
<!-- Update Quiz Modal -->
<div class="modal fade mt-5" id="updateQuestionModal-english" tabindex="-1" aria-labelledby="addQuiz" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update Question (Generic)</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="./endpoint/update-question-english.php" method="POST">
