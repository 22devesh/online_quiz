<!-- Add Quiz Modal -->
<div class="modal fade mt-5" id="addQuestionModal-programming" tabindex="-1" aria-labelledby="addQuiz" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="./endpoint/add-question-programming.php" method="POST">
...
<!-- Update Quiz Modal -->
<div class="modal fade mt-5" id="updateQuestionModal-programming" tabindex="-1" aria-labelledby="addQuiz" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update Question (Hii)</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="./endpoint/update-question-programming.php" method="POST">
                    <div class="form-group" hidden>
                        <label for="updateQuizID">Question ID</label>
                        <input type="text" class="form-control" id="updateQuizID" name="quiz_id">
                    </div>
                    <div class="form-group">
